...
var tokenRepository = connect_1.PostgresDataSource.getRepository(token_entity_1.Token);
var TokenService = /** @class */ (function () {
    function TokenService() {
    }
    TokenService.prototype.generateTokens = function (payload) {
        var accessToken = jsonwebtoken_1.default.sign(payload, process.env.JWT_ACCESS_SECRET, { expiresIn: '1h' });
        var refreshToken = jsonwebtoken_1.default.sign(payload, process.env.JWT_REFRESH_SECRET, { expiresIn: '30d' });
        return {
    ...
    TokenService.prototype.saveToken = function (userId, refreshToken) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, tokenRepository.findOne({ where: {
                                user: {
                                    id: userId
                                }
                            } })];
                    case 1:
                        ...
                        if (tokenData) {
                            ...
                            return [2 /*return*/, tokenRepository.save(tokenData)];
                        }
                        return [4 /*yield*/, tokenRepository.create({ user: userId, refreshToken: refreshToken })];
                    case 2:
                        token = _a.sent();
    ...
    TokenService.prototype.removeToken = function (refreshToken) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, tokenRepository.delete({ refreshToken: refreshToken })];
                    case 1:
                        tokenData = _a.sent();
    ...
    TokenService.prototype.findToken = function (refreshToken) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, tokenRepository.findOne({ where: { refreshToken: refreshToken } })];
                    case 1:
                        tokenData = _a.sent();
                        return [2 /*return*/, tokenData];
                }
